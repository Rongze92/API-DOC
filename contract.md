...
### Security: [None](general-info.md#jie-kou-jian-quan-lei-xing)
...
| side            | number | `1`          | Contract direction(0: backwards，1：forward)                                         |
...
Order Cont.  <mark style="color:red;">MARKET OPEN order here is value</mark>
{% endswagger-parameter %}
...
| `executedQty`  | float  | `20`                 | Order execute quantity                                                                                                                                                                |
